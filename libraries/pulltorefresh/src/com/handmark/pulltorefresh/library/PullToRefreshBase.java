...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private boolean mUseLayoutTextColor;
	private int mLayoutTextColor;
	private int mLayoutSubtextColor;
	...
	@Override
	public void setTextColor(int primary, int subtext) {
		mLayoutTextColor = primary;
		mLayoutSubtextColor = subtext;
		mUseLayoutTextColor = true;
		if(mHeaderLayout != null){
			mHeaderLayout.setTextColor(primary, subtext);
			mFooterLayout.setTextColor(primary, subtext);
		}
	}
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if(mUseLayoutTextColor && mHeaderLayout != null){
			mHeaderLayout.setTextColor(mLayoutTextColor, mLayoutSubtextColor);
		}
		if(mUseLayoutTextColor && mFooterLayout != null){
			mFooterLayout.setTextColor(mLayoutTextColor, mLayoutSubtextColor);
		}
